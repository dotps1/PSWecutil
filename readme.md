...
This is a PowerShell project to wrapper the wecutil.exe with powershell cmdlets.  Still has a way to go, but here is a start.  Feel free to contribute.
...
-----------     ----                                               -------    ------
Function        Get-Subscription                                   0.0.0.1    PSWecutil
Function        Get-SubscriptionRunTimeStatus                      0.0.0.1    PSWecutil
```
...
SubscriptionId                  : AppLockerEvents
...
Delivery                        : Delivery
QueryList                       : {
                                  <QueryList><Query Id="0" Path="Microsoft-Windows-AppLocker/EXE and DLL"><Select
